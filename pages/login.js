            ...
            <div class="w-full flex flex-col  items-center justify-center">
             ...
             <div class="p-4 w-full  ">
                <form class="flex flex-col">
                    ...
                    <div class="w-full flex justify-between mb-5">
                        <div>
                            ...
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-3 font-normal text-base">Remember me</span>
                            </label>
                    ...
                    <button
                        class="w-full text-base rounded-xl font-bold text-white text-center py-2.5 border-2 border-btn bg-btn">Login</button>
                </form>
